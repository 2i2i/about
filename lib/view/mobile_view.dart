...
class MobileViewScreen extends StatefulWidget {
  ...
  const MobileViewScreen({Key? key,required this.scaffoldKey}) : super(key: key);
...
class _MobileViewScreenState extends State<MobileViewScreen> {
  ...
  Container customizationWidget(BuildContext context) {
    return Container(
      padding: margin(),
      child: Column(
        children: [
